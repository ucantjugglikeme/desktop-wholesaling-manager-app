...
# Form implementation generated from reading ui file 'gui-elements/modify-managers-table.ui'
#
...
class UiFrame(object):
    def setupUi(self, Frame):
        ...
        # Frame.resize(704, 891)
        self.horizontalLayoutWidget = QtWidgets.QWidget(Frame)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 691, 861))
        ...
        self.horizontalLayoutWidget_9.setGeometry(QtCore.QRect(0, 20, 191, 51))
        ...
        self.label_19.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.130955, y1:0.347, x2:0.130636, y2:0.682, stop:0 rgba(138, 120, 204, 1), stop:1 rgba(13, 6, 41, 0.9));")
        self.label_19.setObjectName("label_19")
        self.horizontalLayout_9.addWidget(self.frame_9)
        self.lineEdit = QtWidgets.QLineEdit(self.horizontalLayoutWidget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit.sizePolicy().hasHeightForWidth())
        self.lineEdit.setSizePolicy(sizePolicy)
        self.lineEdit.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.label_11.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.130955, y1:0.347, x2:0.130636, y2:0.682, stop:0 rgba(138, 120, 204, 1), stop:1 rgba(13, 6, 41, 0.9));")
        ...
        self.lineEdit_4.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.label_13.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.130955, y1:0.347, x2:0.130636, y2:0.682, stop:0 rgba(138, 120, 204, 1), stop:1 rgba(13, 6, 41, 0.9));")
        ...
        self.lineEdit_5.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.label_15.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.130955, y1:0.347, x2:0.130636, y2:0.682, stop:0 rgba(138, 120, 204, 1), stop:1 rgba(13, 6, 41, 0.9));")
        ...
        self.lineEdit_6.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.horizontalLayoutWidget_8.setGeometry(QtCore.QRect(0, 20, 351, 49))
        ...
        self.label_17.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.130955, y1:0.347, x2:0.130636, y2:0.682, stop:0 rgba(138, 120, 204, 1), stop:1 rgba(13, 6, 41, 0.9));")
        ...
        self.lineEdit_7.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.horizontalLayoutWidget_10.setGeometry(QtCore.QRect(0, 20, 301, 49))
        ...
        self.horizontalLayoutWidget_11.setGeometry(QtCore.QRect(0, 20, 301, 49))
        ...
        self.label_24.setGeometry(QtCore.QRect(60, 0, 181, 16))
        self.label_24.setObjectName("label_24")
        self.horizontalLayoutWidget_12 = QtWidgets.QWidget(self.widget_10)
        self.horizontalLayoutWidget_12.setGeometry(QtCore.QRect(0, 20, 301, 49))
        ...
        self.lineEdit_10 = QtWidgets.QLineEdit(self.horizontalLayoutWidget_12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton.setGeometry(QtCore.QRect(0, 30, 470, 23))
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_18.setText(_translate("Frame", "ID менеджера"))
        self.label_19.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit.setText(_translate("Frame", "3"))
        self.label_10.setText(_translate("Frame", "ФИО менеджера"))
        self.label_11.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_4.setText(_translate("Frame", "Васин Станислав Александрович"))
        self.label_12.setText(_translate("Frame", "Дата рождения"))
        self.label_13.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_5.setText(_translate("Frame", "2002-12-24"))
        self.label_14.setText(_translate("Frame", "Номер отдела"))
        self.label_15.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_6.setText(_translate("Frame", "2"))
        self.label_16.setText(_translate("Frame", "Место жительства"))
        self.label_17.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_7.setText(_translate("Frame", "п. Десеновское, пр-кт Нововатутинский, 12"))
        self.label_20.setText(_translate("Frame", "Электронная почта E-mail"))
        self.label_21.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_8.setText(_translate("Frame", "vasin.s.a@edu.mirea.ru"))
        self.label_22.setText(_translate("Frame", "Рабочий номер"))
        self.label_23.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_9.setText(_translate("Frame", "89150438740"))
        self.label_24.setText(_translate("Frame", "Новый пароль"))
        self.label_25.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.lineEdit_10.setText(_translate("Frame", "Вставить пароль"))
        self.pushButton.setText(_translate("Frame", "Изменить свои данные"))
