...
# Form implementation generated from reading ui file 'gui-elements/delete-warehouses-table.ui'
#
...
class UiFrame(object):
    def setupUi(self, Frame):
        ...
        self.label_18.setGeometry(QtCore.QRect(20, 0, 311, 41))
        self.label_18.setStyleSheet("color: rgb(255, 0, 0);")
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(self.widget_7)
        self.label_19.setGeometry(QtCore.QRect(20, 60, 311, 41))
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_18.setText(_translate("Frame", "<html><head/><body><p>Внимание! Пустые параметры означают удаление всех </p><p>строк из данной таблицы!</p></body></html>"))
        self.label_19.setText(_translate("Frame", "<html><head/><body><p>Слева в таблице будут выводиться оставшиеся строки </p><p>после удаления</p></body></html>"))
        self.pushButton.setText(_translate("Frame", "Удалить склады"))
