...
class UiMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1178, 1313)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.centralwidget.setStyleSheet("")
        self.centralwidget.setObjectName("centralwidget")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 40, 829, 629))
        ...
        self.label_4.setStyleSheet(
            "background-color: qconicalgradient(cx:0.601797, cy:1, angle:252.7, stop:0.477273 "
            "rgba(255, 183, 122, 255), stop:0.801136 rgba(164, 216, 50, 255));"
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Открыть категории товаров на складах"))
        self.label_3.setText(_translate("MainWindow", "Открыть товары на складах"))
        self.label_2.setText(_translate("MainWindow", "Открыть заказы клиентов"))
        self.label_8.setText(_translate("MainWindow", "Открыть клиентов"))
        self.label_6.setText(_translate("MainWindow", "Открыть менеджеров"))
        self.label_7.setText(_translate("MainWindow", "Открыть склады"))
        self.label_10.setText(_translate("MainWindow", "Открыть поставки"))
        self.label_9.setText(_translate("MainWindow", "Открыть поставщиков"))
