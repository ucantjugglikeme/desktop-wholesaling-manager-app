...
# Form implementation generated from reading ui file 'gui-elements/get-products-table.ui'
#
...
class UiFrame(object):
    def setupUi(self, Frame):
        ...
        # Frame.resize(1031, 713)
        self.horizontalLayoutWidget = QtWidgets.QWidget(Frame)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 958, 691))
        ...
        self.label_19.setStyleSheet("background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(120, 75, 227, 255), stop:1 rgba(180, 239, 115, 255));")
        ...
        self.label_22.setGeometry(QtCore.QRect(90, 0, 111, 20))
        ...
        self.label_24.setGeometry(QtCore.QRect(100, 0, 111, 16))
        self.label_24.setObjectName("label_24")
        self.horizontalLayoutWidget_12 = QtWidgets.QWidget(self.widget_10)
        self.horizontalLayoutWidget_12.setGeometry(QtCore.QRect(20, 20, 231, 49))
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_20.setText(_translate("Frame", "ID поставщика"))
        self.label_21.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.pushButton.setText(_translate("Frame", "Вывести товары"))
        self.label_2.setText(_translate("Frame", "<html><head/><body><p>для поиска</p></body></html>"))
        self.label_22.setText(_translate("Frame", "ID категории товара"))
        self.label_23.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.label_24.setText(_translate("Frame", "Категория товара"))
        self.label_25.setText(_translate("Frame", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.pushButton_2.setText(_translate("Frame", "Вывести категории"))
